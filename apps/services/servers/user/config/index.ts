...
export default {
  ...
  UPSTOX_API_KEY: process.env.KITE_API_KEY,
  UPSTOX_API_SECRET: process.env.KITE_API_SECRET,
  UPSTOX_BASE_URL: process.env.KITE_BASE_URL,
  UPSTOX_REDIRECT_URL: process.env.KITE_REDIRECT_URL,
